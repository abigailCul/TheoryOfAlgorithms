...
void sha256(){
  ...
  //Working Variables (Section 6.2)
  uint32_t a, b, c, d, e, f, g, h;
  //Two Temparary Variables (Section 6.2)
  uint32_t T1, T2;

  // The hash Values
//come from section 5.3.3 of standard
  uint32_t H[8]={
      0x6a09e667
    , 0xbb67ae85
    , 0x3c6ef372
  ...
  //Message Block (current)
  uint32_t M[16]={0,0,0,0,0,0,0,0};
  //64 element array of 32 bits unsigned int
  //from page 22, W[t] = M[t] for 0 <= t <=15.
  int i,t;
...
>>>>>>> 6f0551459e0ef45b6f96724f5ff2353c9a201d76
